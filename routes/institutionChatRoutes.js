...
router.post('/upload-media', eitherAuthOrAdmin, labAttachmentsUpload.single('media'), sftpUpload('media', 'media'), institutionCommunicationController.uploadInstitutionMedia);
